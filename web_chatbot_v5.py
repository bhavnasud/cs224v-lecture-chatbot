...
class Chatbot:
    ...
    def _generate_response_with_llm(self, user_query, documents, prev_context):
        ...
        prompt = (
            ...
            f"Do not create new information outside the scope of the provided context, but feel free to synthesize insights if relevant, and try to use multiple sources in your response.\n\n"
            ...
            f"Do not mention that you used the context/documents in your answer.\n\n"
